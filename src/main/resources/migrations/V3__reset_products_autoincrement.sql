-- Reset products table and fix auto_increment to start from 1
-- This will delete all existing products and re-insert with correct IDs starting from 1
...
-- Re-insert sample categories (in case they were affected)
...
-- Re-insert sample products with IDs starting from 1
