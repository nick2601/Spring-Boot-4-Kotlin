package com.example.nikhil.common.kafka.consumer
...
class KafkaConsumerService(
    ...
    fun consumeUserEvent(message: String) {
        try {
            ...
            when (event.action) {
                com.example.nikhil.common.kafka.event.UserAction.REGISTERED -> handleUserRegistered(event)
                com.example.nikhil.common.kafka.event.UserAction.LOGGED_IN -> handleUserLoggedIn(event)
                com.example.nikhil.common.kafka.event.UserAction.PASSWORD_CHANGED -> handlePasswordChanged(event)
